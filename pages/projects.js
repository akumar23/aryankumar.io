...
const StatusBadge = ({ status }) => {
  ...
  return (
    <HStack
      ...
      borderRadius="full"
      border="1px solid"
      borderColor={isLive ? 'rgba(34, 197, 94, 0.3)' : 'rgba(113, 113, 122, 0.3)'}
      bg={isLive ? 'rgba(34, 197, 94, 0.08)' : 'rgba(113, 113, 122, 0.08)'}
    >
      <Box w={1.5} h={1.5} borderRadius="full" bg={isLive ? 'green.400' : 'neutral.500'} />
      <Text
        fontSize="xs"
        fontFamily="mono"
    ...
    >
      <Box
        ...
        _hover={{
          ...
          boxShadow: useColorModeValue('0 12px 40px rgba(0,0,0,0.1)', '0 12px 40px rgba(0,0,0,0.5)'),
      ...
      >
        ...
        <Box
          ...
          style={{ background: `linear-gradient(135deg, ${accent}18 0%, ${accent}05 60%, transparent 100%)` }}
          display="flex"
          alignItems="center"
        ...
        <Box p={4}>
          <HStack justify="space-between" mb={2} align="flex-start">
            <Text fontFamily="mono" fontSize="sm" fontWeight="600" color={textColor} lineHeight="short">
              {name}
            </Text>
            <StatusBadge status={status} />
          </HStack>

          <Text fontSize="sm" color={descColor} lineHeight="tall" mb={3} noOfLines={2}>
            {description}
          </Text>
      ...
      <Link href={href} target="_blank" rel="noopener noreferrer" _hover={{ textDecoration: 'none' }}>
        <Box
          ...
          _hover={{
            ...
            boxShadow: useColorModeValue('0 12px 40px rgba(0, 0, 0, 0.08)', '0 12px 40px rgba(0, 0, 0, 0.4)')
          }}
        ...
        >
          ...
          <Box p={5}>
            <VStack align="start" spacing={3}>
              ...
              <Text fontSize="sm" color={descriptionColor} noOfLines={3} lineHeight="tall">
                {description}
              </Text>
...
const Projects = () => {
  ...
  return (
    <Box>
      {/* Hero */}
      <Box py={{ base: 20, md: 32 }} bg={heroBg} position="relative" overflow="hidden">
        <Container maxW="container.xl" px={{ base: 4, md: 8 }}>
          <VStack spacing={6} textAlign="center">
            ...
            <Text fontSize={{ base: 'lg', md: 'xl' }} color={heroMutedColor} maxW="600px" lineHeight="tall">
      ...
      <Box py={{ base: 12, md: 16 }} bg={sectionBg}>
        <Container maxW="container.xl" px={{ base: 4, md: 8 }}>
          ...
          <Box textAlign="center">
            <ShowMoreButton isExpanded={expandedSections.ai} onClick={() => toggleSection('ai')} count={3} />
          </Box>
        </Container>
      </Box>
